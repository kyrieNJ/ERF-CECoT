...
from model4emo import ContrastiveBERT
...
class Inferer:
    ...
    def processtext_cd_esc(self, user_data_dict):
        ...
        for item in tqdm(user_data_dict):
            for iconv in item:
                ...
                check_dict[user_count]=tmpcheck
    ...
    def evaluate_all(self, user_data_dict):
        ...
        # for i_batch, sample_batched in enumerate(pdata1):
            ...
            for ibatch in range(0, last_dig_encoding.size(0)):
            ...
            for idx in range(len(text_outputs)):
                tmpdata={
...
if __name__ == '__main__':
    ...
    #
    parser.add_argument("--cd_state_dict_path", type=str, default="state_dict/PT_BERTEncoder_cd.pkl")
    parser.add_argument("--emo_state_dict_path", type=str, default="state_dict/PT_BERTEncoder_emo.pkl")
    ...
    model_classes = {
        'PT_BERTEncoder_cd': PT_BERTEncoder,
        'PT_BERTEncoder_emo': ContrastiveBERT,
    ...
    fname=  {
        ...
        'test': '../datasets/smile/smile_test.json'
    ...
    print(len(cd_dict))
    with open('../llama-factory/extra_data/smile_test_cd_label.json', "w",encoding="utf-8-sig") as f:
        json.dump(cd_dict, f, indent=2, ensure_ascii=False)
    with open('../llama-factory/extra_data/smile_test_emo_label_ints.json', "w",encoding="utf-8-sig") as f:
