...
tokenizer = RobertaTokenizer.from_pretrained("/home/wyj/ES_model/roberta-base")
# 载入newSenticKG
        ...
        for key, item in tqdm(user_data_dict.items()):
            ...
            for iconv in item['conversation']:
                ...
                if len(iconv['history'])!=1:
                    # if len(iconv['history'])-3<0:
                    #     last_dig='This is the first round of dialogue.'
                    # else:
                ...
                # if lencon - 1 < 0:
                #     text = 'This is the first round of dialogue.'
                # else:
...
if __name__ == '__main__':
    ...
    fname=  {
        ...
        # 'test': '../datasets/empatheticdialogues/test.json'
        'test': '../datasets/empatheticdialogues/valid.json'
        # 'test': '../datasets/ESConv/esc_test.json'
    ...
    print(len(cd_dict))
    with open('../llama-factory/extra_data/emp_valid_cd_label.json', "w",encoding="utf-8-sig") as f:
        json.dump(cd_dict, f, indent=2, ensure_ascii=False)
    with open('../llama-factory/extra_data/emp_valid_emo_label_ints.json', "w",encoding="utf-8-sig") as f:
