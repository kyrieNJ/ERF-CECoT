...
from data_utils4cd_en import CDDataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='cd_EN', type=str)
    #orthogonal_，xavier_uniform_
    parser.add_argument('--initializer', default='xavier_uniform_', type=str)
    parser.add_argument("--learning_rate", type=float, default=2e-6, help="learning rate.")#large 5e-7
    ...
    model_classes = {
        'PT_BERTEncoder':ContrastiveBERT_CD,
